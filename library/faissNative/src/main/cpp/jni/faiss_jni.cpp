...
extern "C" {
    ...
    Java_pe_brice_rag_library_faissNative_FaissNativeWrapper_initStore(JNIEnv *env, jobject thiz, jint dimension) {
    ...
    Java_pe_brice_rag_library_faissNative_FaissNativeWrapper_addVectors(JNIEnv *env, jobject thiz, jfloatArray java_vectors, jint num_vectors) {
        // --- 초기 검사 (기존과 동일) ---
        if (faiss_index == nullptr) {
    ...
    Java_pe_brice_rag_library_faissNative_FaissNativeWrapper_queryVectors(JNIEnv *env, jobject thiz, jfloatArray java_query_vectors, jint num_query_vectors, jint k_neighbors) {
        if (faiss_index == nullptr) {
            LOGE("Faiss index not initialized. Call initStore or loadIndexNative first.");
            return nullptr;
        }
    ...
    JNIEXPORT jboolean JNICALL
    Java_pe_brice_rag_library_faissNative_FaissNativeWrapper_destroyStore(JNIEnv *env, jobject thiz) {
        if (faiss_index != nullptr) {
    ...
    Java_pe_brice_rag_library_faissNative_FaissNativeWrapper_getNTotal(JNIEnv *env, jobject thiz) {
        if (faiss_index != nullptr) {
    ...
    JNIEXPORT jboolean JNICALL
    Java_pe_brice_rag_library_faissNative_FaissNativeWrapper_isIndexTrained(JNIEnv *env, jobject thiz) {
        if (faiss_index != nullptr) {
    ...
    Java_pe_brice_rag_library_faissNative_FaissNativeWrapper_getDimension(JNIEnv *env, jobject thiz) {
        if (faiss_index != nullptr) {
    ...
    JNIEXPORT jboolean JNICALL
    Java_pe_brice_rag_library_faissNative_FaissNativeWrapper_saveIndexNative(JNIEnv *env, jobject thiz, jstring java_path) {
        if (faiss_index == nullptr) {
    ...
    JNIEXPORT jboolean JNICALL
    Java_pe_brice_rag_library_faissNative_FaissNativeWrapper_loadIndexNative(JNIEnv *env, jobject thiz, jstring java_path) {
        if (java_path == nullptr) {
    ...
    JNIEXPORT jboolean JNICALL
    Java_pe_brice_rag_library_faissNative_FaissNativeWrapper_isIndexLoadedNative(JNIEnv *env, jobject thiz) {
